...
FONT = pygame.font.SysFont("Yerdana", 20)

COLOR_WHITE = (255, 0, 255)
COLOR_BLACK = (0, 0, 0)
COLOR_RED = (255, 0, 0)
COLOR_GREEN = (0, 255, 0)
...
def create_enemy():
    ...
    enemy_rect = pygame.Rect(WIDTH, random.randint(10, 700), *enemy_size)
...
def create_bonus():
    ...
    # bonus_move = [random.randint(-1, -1), 1]
    bonus_rect = pygame.Rect(random.randint(400, 1300), 0, *bonus_size)
